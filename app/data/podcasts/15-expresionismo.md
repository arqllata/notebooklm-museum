...
audioUrl: https://raw.githubusercontent.com/arqllata/notebooklm-museum/main/media/audio/vargas-de-la-llata-francisco-notebooklm.-del-expresionismo-a-tu-pantalla-tactil.mp3
takeaways:
  - Movimiento principalmente alemán y austriaco de principios del siglo XX
    (aprox. 1905).
  - "Se opone radicalmente al Impresionismo: en lugar de captar la impresión del
    mundo exterior, proyecta el dolor, la angustia y la emoción violenta del
    mundo interior."
  - Deformación intencional de la realidad, caras anguladas, perspectivas
    forzadas, colores antinaturales (verdes enfermos, rojos sangrientos).
  - Surgió como respuesta a la alienación de las ciudades industriales masivas y
    la inminencia perturbadora de la Primera Guerra Mundial.
  - "Dos grupos principales en Alemania lideraron la vanguardia: 'Die Brücke'
...
quiz:
  - question: ¿Qué famosa pintura del noruego Edvard Munch, pintada en 1893, se
    ...
    options:
      - option: La Noche Estrellada
      - option: Guernica
      - option: El Grito
      - option: El Beso
    correctAnswer: 2
  - question: ¿Qué cineasta dirigió 'El Gabinete del Dr. Caligari' (1920),
      considerada la obra cumbre del Expresionismo Alemán en cine, con sus
      escenarios distorsionados y pintados?
    options:
      - option: Fritz Lang
      - option: Robert Wiene
