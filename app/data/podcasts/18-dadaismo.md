...
takeaways:
  - Surgió en el Cabaret Voltaire, en Zúrich (país neutral Suiza) en 1916,
    ...
    Guerra Mundial.
  - "Su lógica: si la 'razón', la 'cultura', el 'capitalismo' y la 'lógica'
    occidental habían provocado millones de jóvenes muertos en las trincheras,
    entonces los vanguardistas tenían que abrazar lo absurdo, lo caótico, el
    sin-sentido."
  - Destrucción total del concepto clásico de belleza o habilidad artística
    manual.
  - Pioneros en performances ruidosos anti-poéticos, diseño de revistas caóticas
    de tipografías gritonas asimétricas y los famosos Readymades (objetos
    cotidianos elevados a la categoría de 'Arte' solo porque el artista los
    firma).
  - "Figuras clave: Hugo Ball, Tristan Tzara, Marcel Duchamp y John Heartfield
...
quiz:
  - question: ¿Qué fue el 'Readymade' (objeto encontrado) más notorio del dadaísmo
      ...
      escándalo mayúsculo en el mundo del arte de Nueva York?
    options:
      - option: Un retrete masculino tradicional (mingitorio de porcelana)
      - option: Una llanta de automóvil ardiendo
      - option: Un maniquí de costura apuñalado
      - option: Una Gioconda con bigotes pintados
    correctAnswer: 0
  - question: ¿Qué significado profundo y universal tiene la palabra DADA para el
      grupo suizo creador de este manifiesto?
    options:
      - option: Significa 'Arte y Verdad' en sánscrito antiguo
      - option: Absolutamente nada (como el balbuceo de un bebé francés o eslavo), lo
          eligieron presuntamente clavando un cuchillo al azar en el diccionario
