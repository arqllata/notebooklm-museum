...
takeaways:
  ...
  - Inició a mediados del siglo XIX cuando Japón reabrió sus puertos al comercio
    en 1858 tras 200 años de aislamiento.
  - Los grabados en madera (Ukiyo-e) de artistas como Hokusai y Hiroshige
    revolucionaron el ojo artístico europeo.
  - "Aportó características nuevas: áreas planas de color intenso, falta de
    perspectiva lineal, encuadres asimétricos y motivos de la naturaleza."
  - Influyó profundamente en impresionistas, postimpresionistas (como Van Gogh)
    y el Art Nouveau.
gallery:
...
quiz:
  - question: ¿Qué tipo de arte japonés específico causó un gran impacto en pintores
    ...
    options:
      - option: La ceremonia del té
      - option: Los grabados en madera (Ukiyo-e)
      - option: La arquitectura de los templos sintoístas
      - option: La escultura en bronce de samuráis
    correctAnswer: 1
  - question: ¿Qué característica compositiva del arte japonés rompió la tradición
      artística europea de la perspectiva lineal?
    options:
      - option: El hiperrealismo de los rostros
      - option: La simetría perfecta
