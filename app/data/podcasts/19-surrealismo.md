...
imageUrl: /uploads/dali-01.jpg
audioUrl: "#"
takeaways:
  - Movimiento cultural nacido oficilamente en París tras el Primer Manifiesto
    Surrealista de André Breton en 1924.
  - "Nace a partir de las ruinas irónicas del primer momento Dada, pero con una
    finalidad constructiva e investigativa total: liberar la mente reprimida."
  - Directamente apadrinado por las innovadoras teorías del psicoanálisis del
    Dr. Sigmund Freud y el descubrimiento poderoso del 'inconsciente'.
  - Buscaban provocar el automatismo mental libre de toda norma estética o moral
    del pensamiento diurno (dictado puro del sueño, ilusiones ópticas, frotajes
    aleatorios, pintura al azar y meticuloso realismo mágico fotográfico).
  - Artistas como Salvador Dalí, René Magritte o Joan Miró sentaron el estilo
...
quiz:
  - question: ¿El método o juego colectivo en que los escritores o pintores
      ...
      dibujo impredecible al azar (un poema hecho sin pensarse y pasando el
      papel) se bautizó con qué curioso nombre de cadáver exquisito?
    options:
      - option: Frankenstein literario
      - option: El difunto de letras asimétricas
      - option: El Cadáver Exquisito
      - option: La rifa mental envenenada
    correctAnswer: 2
  - question: ¿A quién se considera la pintora mexicana y figura inexpugnable que
      André Breton al visitarla en México bautizó a su arte y el de su país
      entero de ser 'Surrealista por naturaleza' aún cuando ella renegaba de tal
      asimilación en París?
    options:
      - option: Frida Kahlo
      - option: Leonora Carrington
