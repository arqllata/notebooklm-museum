...
audioUrl: https://raw.githubusercontent.com/arqllata/notebooklm-museum/main/media/audio/03-f-vargas-de-la-llata-francisco-notebooklm-la-identidad-camaleonica-del-art-nouveau.mp3
takeaways:
  ...
  - Sus formas derivan directamente del mundo natural, pero no las copia, sino
    que las estiliza en largas, dinámicas y enredadas líneas asimétricas curvas
    (línea de latigazo o 'coup de fouet').
  - "Es un Arte Total (Gesamtkunstwerk): concebía desde el picaporte de una
    puerta, hasta los muebles decorativamente curvos, y la fachada
    arquitectónica completa."
  - A diferencia del Arts and Crafts de William Morris, el Art Nouveau sí abrazó
    los nuevos materiales industriales como el hierro fundido, el vidrio y el
    concreto, pero dándoles formas orgánicas de plantas.
  - "Recibió distintos nombres por Europa: Modernismo en España/Cataluña,
...
quiz:
  - question: ¿Qué famosas entradas de tren en París, construidas con hierro verde y
      ...
      Hector Guimard?
    options:
      - option: Grand Central Terminal
      - option: Entradas del Metro de París
      - option: La Estación de Atocha
      - option: Estación de King's Cross
    correctAnswer: 1
  - question: ¿A quién se considera el máximo exponente del Modernismo Catalán (la
      variante española del Art Nouveau), creador de la Sagrada Familia y el
      Parque Güell?
    options:
      - option: Victor Horta
      - option: Alphonse Mucha
      - option: Antoni Gaudí
